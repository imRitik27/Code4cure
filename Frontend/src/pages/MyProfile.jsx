...
function MyProfile() {
  ...
  const [image, setImage] = useState(false) // When we change the image then wwe update the image here.

  //Function which call the updateuserprofiledata from the backend. It work when we click on the the edit button.

  const updateUserProfileData = async () => {
    try {
      const formData = new FormData()
      // When e click on the edit button data same dil=khe but editable ho
