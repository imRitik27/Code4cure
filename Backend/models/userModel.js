// Here we will create the mongoose model for the Users using that we can store the Users data in our databbase.
...
// Create the Models
const userModel = mongoose.models.user || mongoose.model('user', userSchema)  //  If the model already exists in mongoose.models, it reuses it.
